...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 p-2 rounded-full bg-card shadow-md border border-border hover:bg-muted transition-colors z-50 flex items-center justify-center"
